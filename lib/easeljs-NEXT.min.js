...
(function(){var c=function(a,b,h,d,c,f,g){this.initialize(a,b,h,d,c,f,g)},b=c.prototype;b.target=null;b.overLabel=null;b.outLabel=null;b.downLabel=null;b.play=!1;b._isPressed=!1;b.initialize=function(a,b,h,d,c,f,g){a.addEventListener&&(this.target=a,this.overLabel=null==h?"over":h,this.outLabel=null==b?"out":b,this.downLabel=null==d?"down":d,this.play=c,a.cursor="pointer",this.setEnabled(!0),this.handleEvent({}),f&&(g&&(f.actionsEnabled=!1,f.gotoAndStop(g)),a.hitArea=f))};b.setEnabled=function(a){var b=
this.target;a?(b.addEventListener("mouseover",this),b.addEventListener("mouseout",this),b.addEventListener("mousedown",this),b.addEventListener("click",this)):(b.removeEventListener("mouseover",this),b.removeEventListener("mouseout",this),b.removeEventListener("mousedown",this),b.removeEventListener("click",this))};b.toString=function(){return"[ButtonHelper]"};b.handleEvent=function(a){var b="mouseover"==a.type&&!this._isPressed||"click"==a.type?this.overLabel:"mouseover"==a.type&&this._isPressed||
"mousedown"==a.type?this.downLabel:this.outLabel;if("mousedown"==a.type)this._isPressed=!0,a.addEventListener("mouseup",this);else if("mouseup"==a.type){this._isPressed=!1;return}this.play?this.target.gotoAndPlay(b):this.target.gotoAndStop(b)};createjs.ButtonHelper=c})();this.createjs=this.createjs||{};(function(){var c=function(a,b,h,d){this.initialize(a,b,h,d)},b=c.prototype;c.identity=null;b.color=null;b.offsetX=0;b.offsetY=0;b.blur=0;b.initialize=function(a,b,h,d){this.color=a;this.offsetX=b;this.offsetY=h;this.blur=d};b.toString=function(){return"[Shadow]"};b.clone=function(){return new c(this.color,this.offsetX,this.offsetY,this.blur)};c.identity=new c("transparent",0,0,0);createjs.Shadow=c})();this.createjs=this.createjs||{};
...
b._handlePointerMove(a,c,h,d)};c._handleEnd=function(b,a,c){var h=b.__touch,d=h.pointers;d[a]&&(h.count--,b._handlePointerUp(a,c,!0),delete d[a])};createjs.Touch=c})();(function(){var c=this.createjs=this.createjs||{},c=c.EaselJS=c.EaselJS||{};c.version="NEXT";c.buildDate="Fri, 11 Jan 2013 01:06:33 GMT"})();(function(){var c=this.createjs=this.createjs||{},c=c.MovieClip=c.MovieClip||{};c.version="NEXT";c.buildDate="Wed, 09 Jan 2013 04:14:26 GMT"})();
